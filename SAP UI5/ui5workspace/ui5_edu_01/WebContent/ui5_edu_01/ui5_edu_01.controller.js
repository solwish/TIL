				...
				"ui5_edu_01.ui5_edu_01",
				{
					...
					onInit : function() {
						oModel = new sap.ui.model.odata.ODataModel(
								"proxy/http/ehp8.innoever.net:8080/sap/opu/odata/sap/ZEDU05_CRUD_SRV");
					...
					save : function(key) {
						...
						if (mode == 'create') {
							...
							oModel.update("/CRUDSet(Sabun='"
									+ newData.Sabun + "')", newData, null,
									function() {
										sap.ui.getCore().getModel().refresh();
										$("#form1").slideUp();
									}, function() {
							...
							oModel.remove("/CRUDSet(Sabun='" + key + "')",
